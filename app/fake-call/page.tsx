...
import { PhoneOff, Mic, MicOff, UserCircle } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col items-center justify-between p-8 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-between h-full w-full max-w-md">
        ...
        <div className="flex flex-col items-center pt-12">
          ...
          <h2 className="text-white text-2xl font-semibold mb-1">Sarah Johnson</h2>
          <p className="text-white/60 text-sm">Mobile +33 6 ** ** ** 89</p>
        </div>
          ...
          <div className="relative">
            ...
            {isConnected && (
              <>
                ...
                <div className="absolute inset-0 rounded-full bg-primary/10 animate-ping animation-delay-200" />
              </>
            )}

            {/* Profile picture */}
            <div className="relative w-48 h-48 rounded-full bg-gradient-to-br from-primary/80 to-primary/40 flex items-center justify-center shadow-2xl">
              <UserCircle className="w-32 h-32 text-white/90" />
            </div>
          </div>
        </div>
